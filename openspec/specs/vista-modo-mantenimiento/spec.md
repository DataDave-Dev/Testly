...
Define los requisitos de la vista de modo mantenimiento de Testly: única
página pública del sitio mientras no existe el resto del producto. Traduce
el boceto `docs/diseno/modo-mantenimiento/modo-mantenimiento.dc.html` a Astro
real, con countdown a la fecha límite del proyecto, bandas de marquee
animadas con GSAP y estilos con Tailwind CSS v4.
